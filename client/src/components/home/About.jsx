                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-16">
                    ...
                    >
                        <div className="card">
                            ...
                            <p className="text-text-secondary leading-relaxed">{ABOUT_CONTENT.intro}</p>
                        </div>

                        <div className="card">
                            <h3 className="text-2xl font-bold gradient-text mb-4">My Journey</h3>
                            <p className="text-text-secondary leading-relaxed">{ABOUT_CONTENT.journey}</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="card">
                            <h3 className="text-2xl font-bold gradient-text mb-4">My Goal</h3>
                            <p className="text-text-secondary leading-relaxed">{ABOUT_CONTENT.goal}</p>
                        </div>

                        <div className="card">
                            <h3 className="text-2xl font-bold gradient-text mb-4">Skills & Expertise</h3>
                            <p className="text-text-secondary leading-relaxed">{ABOUT_CONTENT.skills}</p>
                        </div>
                    </motion.div>
                </div>
                                ...
                                >
                                    ...
                                    <div className={`w-full md:w-5/12 ml-12 md:ml-0 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                                        <div className="card hover:shadow-xl hover:shadow-accent-cyan/10">
                                            <div className="text-accent-cyan font-bold mb-2">{item.year}</div>
